...
define internal double @"_ZN3std3f6421_$LT$impl$u20$f64$GT$8copysign17hff82d4e728364f6dE"(double %self, double %sign) unnamed_addr #0 {
start:
...
; call std::f64::<impl f64>::copysign
  %_1 = call double @"_ZN3std3f6421_$LT$impl$u20$f64$GT$8copysign17hff82d4e728364f6dE"(double 1.000000e+00, double -1.000000e+00) #3
  ret void
}
