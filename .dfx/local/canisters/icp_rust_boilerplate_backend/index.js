...
export const canisterId = process.env.CANISTER_ID_ICP_RUST_BOILERPLATE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_rust_boilerplate_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_rust_boilerplate_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_rust_boilerplate_backend.did.js")._SERVICE>}
 */
